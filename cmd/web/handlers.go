...
func home(w http.ResponseWriter, r *http.Request) {
	...
	// into a template set. Note the use of a variadic parameter.
	...
	// On success, use the Execute() method on the template set to write
	// the template content as the response body. The last parameter to
	// Execute() represents any dynamic data that we want to pass in,
